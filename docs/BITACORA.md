...
| 50 | 18 | Bajábamos a 2 requests por segundo por una cortesía inventada: el servidor aguanta 80 req/s con 16 conexiones y cero errores | Prueba con 60 páginas al azar a 4, 8 y 16 hilos | Descarga en paralelo con 8 hilos y sin espera artificial; 918 normas en 7,7 min | Medir el límite real antes de asumirlo: el nuestro era 160 veces más lento |
| 51 | 18 | Agregar la Ley 14.250 como semilla hacía saltar el corpus de 931 a 46.878 normas | Proyección sobre el catálogo antes de bajar nada | Filtro de tipos por semilla: las homologaciones de convenios no entran | Una ley con 42.424 "modificatorias" no es una ley con historia, es un registro |
| 52 | 18 | El embebido se colgó 18 minutos y murió buscando un archivo en HuggingFace con el modelo ya en caché | Traceback con cached_file | `HF_HUB_OFFLINE=1` | Una dependencia que llama a la red en cada arranque es un punto de fallo silencioso |
